  ...
  $(function () {
    ...
    function setValues(theValue) {
      ...
      document.getElementById("memberIntro").innerHTML =
        "<p><h1>" +
        members[theValue].name +
        "</h1>" +
        members[theValue].introText +
        "</p>";
      document.getElementById("memberName").innerHTML =
        "<Strong>Name: </Strong>" + members[theValue].name;
      document.getElementById("memberLocation").innerHTML =
        "<Strong>Location: </Strong>" + members[theValue].location;
      document.getElementById("memberMail").innerHTML =
        "<Strong>Email: </Strong>" + members[theValue].email;
      document.getElementById("memberPhone").innerHTML =
        "<Strong>Phone: </Strong>" + members[theValue].phone;
      console.log("yeeee");
    }
